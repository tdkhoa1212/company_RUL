...
train_dir = os.path.join(opt.main_dir_colab, '/PHM_data/Learning_set/')
test_dir = os.path.join(opt.main_dir_colab, '/PHM_data/Test_set/')
saved_dir = os.path.join(opt.main_dir_colab, '/PHM_data/saved_data/')
...
if os.path.exists(saved_dir + 'Bearing1_1_' + '1d') == False:
  for type_data in opt.data_type:
    ...
    save_df(os.path.join(saved_dir, 'Bearing1_2_data' + type_data), Bearing1_2['x'])
    save_df(os.path.join(saved_dir, 'Bearing1_3_data' + type_data), Bearing1_3['x'])
    save_df(os.path.join(saved_dir, 'Bearing1_4_data' + type_data), Bearing1_4['x'])
    save_df(os.path.join(saved_dir, 'Bearing1_5_data' + type_data), Bearing1_5['x'])
    save_df(os.path.join(saved_dir, 'Bearing1_6_data' + type_data), Bearing1_6['x'])
    save_df(os.path.join(saved_dir, 'Bearing1_7_data' + type_data), Bearing1_7['x'])

    save_df(os.path.join(saved_dir, 'Bearing1_1_label_RUL'), Bearing1_1['y'])
    save_df(os.path.join(saved_dir, 'Bearing1_2_label_RUL'), Bearing1_2['y'])
    save_df(os.path.join(saved_dir, 'Bearing1_3_label_RUL'), Bearing1_3['y'])
    save_df(os.path.join(saved_dir, 'Bearing1_4_label_RUL'), Bearing1_4['y'])
    save_df(os.path.join(saved_dir, 'Bearing1_5_label_RUL'), Bearing1_5['y'])
    save_df(os.path.join(saved_dir, 'Bearing1_6_label_RUL'), Bearing1_6['y'])
    save_df(os.path.join(saved_dir, 'Bearing1_7_label_RUL'), Bearing1_7['y'])
