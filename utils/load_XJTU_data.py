...
if os.path.exists(saved_dir + 'Bearing1_1_' + '1d') == False:
  for type_data in opt.data_type:
    ...
    save_df(join(saved_dir, 'Bearing1_1_data_' + type_data + '.pkz'), Bearing1_1['x'])
    ...
    save_df(join(saved_dir, 'Bearing1_2_data_' + type_data + '.pkz'), Bearing1_2['x'])
    ...
    save_df(join(saved_dir, 'Bearing1_3_data_' + type_data + '.pkz'), Bearing1_3['x'])
    ...
    save_df(join(saved_dir, 'Bearing1_5_data_' + type_data + '.pkz'), Bearing1_5['x'])
    ...
    save_df(join(saved_dir, 'Bearing2_1_data_' + type_data + '.pkz'), Bearing2_1['x'])
    ...
    save_df(join(saved_dir, 'Bearing2_2_data_' + type_data + '.pkz'), Bearing2_2['x'])
    ...
    save_df(join(saved_dir, 'Bearing2_3_data_' + type_data + '.pkz'), Bearing2_3['x'])
    ...
    save_df(join(saved_dir, 'Bearing2_4_data_' + type_data + '.pkz'), Bearing2_4['x'])
    ...
    save_df(join(saved_dir, 'Bearing2_5_data_' + type_data + '.pkz'), Bearing2_5['x'])
    save_df(join(saved_dir, 'Bearing2_5_label_RUL') , Bearing2_5['y'])
    save_df(join(saved_dir, 'Bearing2_5_label_Con') , Bearing2_4_label_Con)
    ...
    save_df(join(saved_dir, 'Bearing3_1_data_' + type_data + '.pkz'), Bearing3_1['x'])
    ...
    save_df(join(saved_dir, 'Bearing3_3_data_' + type_data + '.pkz'), Bearing3_3['x'])
    ...
    save_df(join(saved_dir, 'Bearing3_4_data_' + type_data + '.pkz'), Bearing3_4['x'])
    ...
    save_df(join(saved_dir, 'Bearing3_5_data_' + type_data + '.pkz'), Bearing3_5['x'])
    save_df(join(saved_dir, 'Bearing3_5_label_RUL') , Bearing3_5['y'])
    save_df(join(saved_dir, 'Bearing3_5_label_Con.pkz') , Bearing3_5_label_Con)
